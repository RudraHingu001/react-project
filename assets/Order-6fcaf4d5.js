import{r as a,R as p,j as s}from"./index-565df7a8.js";import{m as v}from"./myContext-755992e1.js";import{L as y}from"./Layout-1f641c7f.js";import h from"./Loader-a29d2784.js";import{a as c}from"./FirebaseConfig-f1ddf40d.js";import{T as b}from"./table-643afc6e.js";import"./index-bea2a320-8c0c8ce8.js";function O(){const i=a.useContext(v),{loading:l,order:d}=i,[m,u]=a.useState([]),t=c.currentUser?c.currentUser.email:null;a.useEffect(()=>{if(t){const e=d.filter(o=>o.email===t);u(e)}},[d,t]);const f=p.useMemo(()=>[{Header:"Payment Id",accessor:"paymentId"},{Header:"Total",accessor:"grandTotal"},{Header:"Name",accessor:e=>e.addressInfo.name},{Header:"Address",accessor:e=>`${e.addressInfo.roomNo||""}, ${e.addressInfo.society||""}, ${e.addressInfo.street||""}, ${e.addressInfo.city||""} , ${e.addressInfo.pincode}`},{Header:"Phone Number",accessor:e=>e.addressInfo.phoneNumber},{Header:"Email",accessor:"email"},{Header:"Date",accessor:e=>e.date},{Header:"Product Info",accessor:e=>{const o=e.cartItems.map(r=>{const n=r.colors.find(g=>g.hex===r.selectedColor),x=n?n.name:"Unknown Color";return`
